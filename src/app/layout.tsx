...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <script defer data-domain="nadimtuhin.com" src="https://null.app.nadimtuhin.com/js/script.file-downloads.hash.outbound-links.pageview-props.revenue.tagged-events.js"></script>
      </head>
